    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col mb-2 d-flex flex-column">
                ...
                <asp:TextBox ID="txtClienteEmail" CssClass="form-control" placeholder="ejemplo@gmail.com" MaxLength="50" runat="server" ReadOnly="true"></asp:TextBox>
                <div style="min-height: 1.5em;">
        ...
        <div class="row">
            <div class="col mb-2 d-flex flex-column">
                ...
                <asp:TextBox ID="txtClienteNombre" CssClass="form-control" placeholder="Juan" MaxLength="50" runat="server" ReadOnly="true"></asp:TextBox>
                <div style="min-height: 1.5em;">
            ...
            <div class="col mb-2 d-flex flex-column">
                ...
                <asp:TextBox ID="txtClienteApellido" CssClass="form-control" placeholder="Pérez" MaxLength="50" runat="server" ReadOnly="true"></asp:TextBox>
                <div style="min-height: 1.5em;">
        ...
        <div class="row">
            <div class="col mb-2 d-flex flex-column">
                ...
                <asp:TextBox ID="txtClienteDireccion" CssClass="form-control" placeholder="Gavilán 2151" MaxLength="50" runat="server" ReadOnly="true"></asp:TextBox>
                <div style="min-height: 1.5em;">
            ...
            <div class="col mb-2 d-flex flex-column">
                ...
                <asp:TextBox ID="txtClienteCiudad" CssClass="form-control" placeholder="CABA" MaxLength="50" runat="server" ReadOnly="true"></asp:TextBox>
                <div style="min-height: 1.5em;">
            ...
            <div class="col mb-2 d-flex flex-column">
                ...
                <asp:TextBox ID="txtClienteCP" CssClass="form-control" placeholder="1416" MaxLength="4" runat="server" ReadOnly="true"></asp:TextBox>
                <div style="min-height: 1.5em;">
